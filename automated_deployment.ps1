...
#$baseDir = "C:\Users\Andrew.Piper\OneDrive - Sabey Corporation\Documents\Automated_Deployment_Logic" #Andrew Pipers path. Comment and uncomment as needed
$baseDir = "C:\Users\andy1\Documents\Automated_Depolyment_Logic"
...
function Show-MainMenu {
    do {
        ...
        Write-Host "| Juniper Switch Automated Deployment Tool.                  |" -ForegroundColor Cyan
        Write-Host "| Developed (with the great aid of ChatGPT) by Andrew Piper. | " -ForegroundColor Cyan
        Write-Host "| For assistance, reach out to andrew.piper@sabey.com        |" -ForegroundColor Cyan
        Write-Host " ============================================================" -ForegroundColor Cyan
        Write-Host "`nMain Menu Options" -ForegroundColor Green
...
function Show-NewInstallMenu {
    ...
    do {
        ...
        Write-Host "`n1) Template"
        Write-Host "2) Baremetal Installation (not built yet)"
